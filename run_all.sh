...
PROJECTS=("inlining" "virtual" "noexcept" "exception" "cache_locality" "branch_prediction" "ilp_no_data_dependencies" "ilp_data_dependencies" "malloc" "containers/vector" "containers/hashmap" "containers/treemap" "containers/hashset" "containers/treeset")
